 ...
 * (rate limited).
 */
// TODO(project): add any status your backend uses to signal a retryable client error.
  ...
  return new QueryClient({
    ...
    defaultOptions: {
      queries: {
         ...
         */
        // TODO(project): raise per-query for reference data, lower for volatile data.
        staleTime: 60_000,
        /**
      ...
      dehydrate: {
         ...
         */
        // TODO(project): set this to `true` if any raw backend error can reach dehydration.
